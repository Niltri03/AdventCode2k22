...
string creaStringSortable(string &s)
{
    ...
    for(int i = 0; i < s.size(); ++i){
        if(s[i] == '2') ret.append("a"); 
        else if(s[i] == '3') ret.append("b");
        else if(s[i] == '4') ret.append("c");
        else if(s[i] == '5') ret.append("d");
        else if(s[i] == '6') ret.append("e");
        else if(s[i] == '7') ret.append("f");
        else if(s[i] == '8') ret.append("g");
        else if(s[i] == '9') ret.append("h");
        else if(s[i] == 'T') ret.append("i");
        else if(s[i] == 'J') ret.append("j");
